...
(function (testRunner) {
    ...
    function addReporters(config, capabilitiesIndex, reporters) {
        ...
        function getPrefix() {
            var currentCapabilities = config.capabilities[capabilitiesIndex];
    ...
    function initWebdriverCSS(config, currentCapabilities) {
        ...
        var name = currentCapabilities.name || currentCapabilities.browserName;
        var screenshotRoot = path.join(config.webdrivercss.screenshotRoot, currentCapabilities.name);
        var failedComparisonsRoot = path.join(config.webdrivercss.failedComparisonsRoot, currentCapabilities.name);
