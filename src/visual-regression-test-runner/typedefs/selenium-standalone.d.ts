declare module 'selenium-standalone' {
  ...
  export function start(opts: StartOpts, cb: (error?: any, child?: child_process.ChildProcess) => void): void;
  export function start(cb: (error?: any, child?: child_process.ChildProcess) => void): void;
}